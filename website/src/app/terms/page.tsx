...
export const metadata: Metadata = {
  ...
  description:
    'Our terms of service policy outlines what you can expect from us and what we expect from you our user.',
}

function Terms(props: any) {
  return (
    <div className={`legal flex justify-center px-4 py-12`}>
      <div className="max-w-5xl" data-custom-class="body">
        <div data-custom-class="body">
          ...
          <div style={{ textAlign: 'left', lineHeight: '1.5' }}>
            ...
            >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <span className="question">Canada</span>
                          <span className="statement-end-if-in-editor">
                            <span
                              style={{
                                fontSize: '11.0pt',
                      ...
                      <span className="question">400 – 1168 Hamilton St</span>
                      <span className="block-component" />
                    </span>
                  </span>
                  , <span className="question">Vancouver</span>
                </span>
              </span>
                  ...
                  <span style={{ fontSize: '15px' }}>
                    <span data-custom-class="body_text">
                      <span style={{ color: 'rgb(89, 89, 89)' }}>
                        <span className="block-component" />,{' '}
                        <span className="question">British Columbia</span>
                        <span className="block-component" />
                        <span className="block-component" />{' '}
                        <span className="question">V6B 2S2</span>
                        <span className="statement-end-if-in-editor" />
                      </span>
                    </span>
                  </span>
              ...
              <span className="statement-end-if-in-editor" />
              <span className="block-component" /> You agree that by accessing
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <span className="question">U.S. dollars</span>.
                  </span>
                </div>
              </span>
              <span
          ...
          <div style={{ textAlign: 'left', lineHeight: '1.5' }}>
            ...
            >
              ...
              >
                ...
                Site (&qout;Submissions&qout;) provided by you to us are
          ...
          <div style={{ textAlign: 'left', lineHeight: '1.5' }}>
            ...
            >
              <span style={{ fontSize: '15px' }}>
                ...
                <span className="question">Canada</span>
                <span className="statement-end-if-in-editor" />.{' '}
                <span className="question">Nano 3 Labs Ltd.</span> and yourself
          ...
          >
            <span style={{ fontSize: '15px' }}>
              ...
              <span className="question">three (3)</span>. The seat, or legal
              ...
              <span className="question">Canada</span>
              <span className="statement-end-if-in-editor" />
              <span className="else-block" />. The language to be used in the
              arbitral proceedings shall be{' '}
              <span className="question">English</span>. The governing law of
                              ...
                              <span data-type="if">
                                <span data-type="conditional-block">
                                  <span data-type="body">
                                    ...
                                    DURING THE{' '}
                                    <span className="question">SIX (6)</span>{' '}
          ...
          >
            <span className="question">
              <strong>
                <span style={{ fontSize: '15px' }}>michael@nano3labs.com</span>
              </strong>
            </span>
          </div>
        </div>
